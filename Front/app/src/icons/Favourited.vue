<template>
    <div  @click="homePageNav" :class=" isFavouritedClicked ? 'border-2 border-black cursor-pointer w-[30px] h-[30px] p-1 rounded-full flex justify-center items-center' : 'cursor-pointer'">
...
import { isFavouritedClicked } from '@/composables/useClickedNavigator';
...
function homePageNav(){
  router.push('/dashboard/favourited')
  Navigator(2)
}
</script>